...
def home():
   ...
   return render_template("home.html", current_user=current_user, users=users)
...
def numberguessinggame_finish():
   ...
   return render_template("nggfinish.html", count=count, guesses=guesses, final_number=final_number, points = points, numberguessinggamesame= numberguessinggamesame, current_user=current_user)
